...
function validateForm() {
    ...
    if(fnameInput.value.trim()==''){
        setError(fnameInput, 'This field cannot be empty.');
        swal({
             title: "Fields Empty!!!",
     ...
     if(lnameInput.value.trim()==''){
        setError(lnameInput, 'This field cannot be empty.');
        swal({
            title: "Fields Empty!!!",
            text: "Please try to check!",
            icon: "warning",
    ...
    if(emailInput.value.trim()==''){
      ...
      if(bdateInput.value.trim()==''){
        setError(bdateInput, 'This field cannot be empty.');
        swal({
            title: "Fields Empty!!!",
            text: "Please check!",
            icon: "warning",
    ...
    //        });
      ...
      if(pnumberInput.value.trim()==''){
        setError(pnumberInput, 'This field cannot be empty.');
        swal({
            title: "Empty Fields",
...
//     ageMS = Date.parse(Date()) - Date.parse(bdate);
//     age = new Date();
//     age.setTime(ageMS);
...
//   }
  ...
  $('#bdate').datepicker("option", "onSelect", function(dateText, inst) {
